                        ...
                        <div className="fancy-btn">
                            {isLoggedIn
                                ...
                                <>
                                    ...
                                    <Button variant="outline-primary" onClick={() => this.props.history.push("/store")}>Store</Button>
                                    <Button variant="outline-primary" onClick={() => this.props.history.push("/profile")}>My Profile</Button>
